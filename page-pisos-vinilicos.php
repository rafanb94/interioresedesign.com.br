		...
		<div class="container-lg">
			<div class="durafloor">
				<header class="product-title d-flex ai-center my-5">
						<h2>Pisos Vinílicos Durafloor</h2>
			...
			<div class="ospefloor mt-5">
				<header class="product-title d-flex ai-center my-5">
						<h2>Pisos Vinílicos Ospefloor</h2>
						<img class="ml-2" style="object-fit:contain;" width=80 height=80 src="<?php the_field('page_provider_ospefloor'); ?>" alt="">
				</header>
					<?php 
